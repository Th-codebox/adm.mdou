...
class StreetTypeController extends BackEndController
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['StreetType'];
			if($model->save())
...
//				$this->redirect(array('view','id'=>$model->id));
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('StreetType', array(
		    'sort'=>array(
	...
	{
		$model=StreetType::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='street-type-form')
		{
